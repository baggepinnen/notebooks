...
# ╔═╡ 78958f50-746c-4451-90cf-5e5b0059efc7
using ControlSystemIdentification, ControlSystemsBase, DelimitedFiles, Plots

# ╔═╡ b7295fba-b859-403e-bc30-a3a6fe6f48f7
md"""
# Validation

- How to verify that an estimated model is good enough
- With real data, we have no true model to compare to
- An annotated version of this notebook with additional comments is provided [here](https://baggepinnen.github.io/ControlSystemIdentification.jl/dev/examples/hair_dryer/)
"""

# ╔═╡ 964775ec-5d53-4cee-9bfb-a7b2ec3d4ae3
plotly(); theme(:dark)

# ╔═╡ 0189a63c-685f-4efc-b3f7-0e3f4c85dc69
md"""

# Experimental data

From industrial heating process, The example comes from [STADIUS's Identification Database](https://homes.esat.kuleuven.be/~smc/daisy/daisydata.html).
...
# ╔═╡ 0a7d8a8a-583e-11ee-0c33-150158f0df94
begin
	...
	u = data[:, 1]' # voltage
	y = data[:, 2]' # air temp
	d0 = iddata(y, u, 0.08) # sample time not specified for data, 0.08 is a guess
end

# ╔═╡ 39b9fd9a-b453-4259-acaf-585298e4ef84
plot(
    plot(d0),
    coherenceplot(d0),
)

# ╔═╡ 4af928a9-afa6-4b7f-98d0-93975da0e5f9
begin
	d = detrend(d0)
	impulseestplot(d, 40, σ=3)
end

# ╔═╡ bbd82cd7-1405-46a4-a8be-eafba76324c9
begin
	dtrain = d[1:end÷2]
	dval = d[end÷2:end]
...
# ╔═╡ fb49b1f0-8c65-4d55-be54-0801d778edef
predplot(model_pem, dval, h=10, sysname="PEM")

# ╔═╡ 4bc4e845-2d12-4f2d-a8d1-4038ec560ac0
begin
...
# ╔═╡ 555f9d7e-f1d4-4966-8966-85ddec2ba1b8
begin
...
# ╔═╡ 37ad55a9-07db-4272-b987-146a000d7e19
begin
	residualplot(model_pem, dval, lab="PEM")
	residualplot!(model_arx, dval, lab="ARX")
end

# ╔═╡ 570f4fc9-700e-4cd9-ab13-dcdb8d6a444c
md"""
# Summary
Validation can be performed by
- Testing simulation and prediciton performance on validation data
- Inspect model residuals
- Estimating models using different methods and check that they agree
"""
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "1726b119606205edae63f038940d4c5ac5ae6206"
